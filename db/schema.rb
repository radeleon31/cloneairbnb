...
ActiveRecord::Schema.define(version: 2021_02_26_151152) do
  ...
  create_table "booking_reviews", force: :cascade do |t|
    ...
    t.bigint "helicopter_id"
    t.index ["booking_id"], name: "index_booking_reviews_on_booking_id"
    t.index ["helicopter_id"], name: "index_booking_reviews_on_helicopter_id"
  end
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["helicopter_id"], name: "index_bookings_on_helicopter_id"
